...
CREATE TABLE `entreprise` (
  ...
  `nom_de_l'ayant_droit` varchar(45) NOT NULL,
  `prenom_de_l'ayant_droit` varchar(45) NOT NULL,
  `fonction_au_sein_de_l'entreprise` varchar(45) NOT NULL,
  `adresse` varchar(45) NOT NULL,
...
-- Dump completed on 2020-12-24 12:17:39
